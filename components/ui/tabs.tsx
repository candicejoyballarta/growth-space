...
const tabsListVariants = cva("inline-flex ", {
  variants: {
    variant: {
      default:
        "items-center h-10 rounded-md bg-muted p-1 text-muted-foreground",
      outline: "",
...
const tabsTriggerVariants = cva("inline-flex items-center", {
  variants: {
    variant: {
      default:
      ...
      outline:
        "px-3 py-1.5 text-sm font-medium ring-offset-background transition-all data-[state=active]:border-b-2",
      // Add more variants here
    },
  },
  defaultVariants: {
